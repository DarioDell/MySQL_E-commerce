...
-- Gross Margin: The difference between the MSRP and the buyPrice. It tells you how much you earn in absolute terms for each product sold.
-- Profit Margin: The gross margin as a percentage of the buyPrice. Here the profit margin is being calculated as a percentage of the purchase price. In other words, it tells you what percentage of the purchase price the profit is.

-- I have find out that the profit margins in this type of business (depending on the product selected) are between 30% and 80%. The new column called 'margin_classification' will be responsible for telling me which product is profitable ('YES') and which are not profitable ('NO').
-- The product will be profitable when the profitability percentage is greater than 30%.

-- As a result, profit margins are relatively high in all products. Most likely each company has got their own people dealing with the numbers and making conclusions about it. 
-- While its measurement is crucial, benchmarking of your margins against your direct competitors will give you a better perspective of your standing in the market. 
-- The overall idea that one should have a higher margin than their competitors is usually favorable.